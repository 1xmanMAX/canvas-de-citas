...
> **App publicada:** https://1xmanmax.github.io/canvas-de-citas/ · código en [`app/`](app/) (ver [`app/README.md`](app/README.md)).
> Los mockups HTML de este paquete están en la raíz del repo.
