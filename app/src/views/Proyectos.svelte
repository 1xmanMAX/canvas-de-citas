...
<header class="cabecera">
  ...
  <button class="btn solo-escritorio" onclick={abrirDatos}><Icono nombre="datos" />Datos</button>
  <button class="icono-btn solo-movil" aria-label="Datos" onclick={abrirDatos}><Icono nombre="datos" tam={18} /></button>
